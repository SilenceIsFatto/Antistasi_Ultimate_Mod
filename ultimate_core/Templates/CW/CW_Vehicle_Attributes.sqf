["attributesVehicles", [
    // Droid Helis
    ["3AS_Patrol_LAAT_Police", ["cost", 100]], // [_classname, [_type, _integer]],
    ...
    // Clone Helis
    ["3AS_Patrol_LAAT_Republic", ["cost", 100]], // [_classname, [_type, _integer]],
    ["3as_LAAT_Mk2", ["cost", 150]], // [_classname, [_type, _integer]],
    ["3as_LAAT_Mk1", ["cost", 150]], // [_classname, [_type, _integer]],
