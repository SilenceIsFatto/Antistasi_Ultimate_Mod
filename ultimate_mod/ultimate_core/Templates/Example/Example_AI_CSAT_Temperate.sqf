...
["name", "CSAT Example Replace"] call _fnc_saveToTemplate;
["spawnMarkerName", "CSAT Example Support Corridor"] call _fnc_saveToTemplate;
...
#include "Example_Vehicle_Attributes.sqf"
